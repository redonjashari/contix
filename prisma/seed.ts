  ...
  const events = [
    {
      ...
      endAt: new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000),
      genre: 'Pop',
    ...
    },
    {
      ...
      endAt: new Date(now.getTime() + 45 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000),
      genre: 'Rock',
    ...
    },
    {
      ...
      endAt: new Date(now.getTime() + 60 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000),
      genre: 'Alternative',
    ...
    },
    {
      ...
      startAt: new Date(now.getTime() + 75 * 24 * 60 * 60 * 1000),
      endAt: new Date(now.getTime() + 75 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000),
      genre: 'R&B',
